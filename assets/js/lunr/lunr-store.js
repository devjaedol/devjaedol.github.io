var store = [{
        "title": "MarkDown 사용법",
        "excerpt":"MakrDown에 사용 법에 대해서 간략히 보시죠. 확장자 *.md 입니다. 대표적 예제 Readmd.md. 사용처, 경량 기반 텍스트 마크업 언어   정보 개발 존 그루버, 에런 스워츠 발표일 2004년 3월 19일 최신 버전 1.0.1 (2004년 12월 17일) 포맷 종류 마크업 언어 헤더 설정하는 방법 두줄 밑줄을 통해서 헤더 설정 ============= 두줄 밑줄을...","categories": ["etc"],
        "tags": ["mk","markdown"],
        "url": "/etc/markdown/",
        "teaser": null
      },{
        "title": "GitHub blog 오픈",
        "excerpt":"GitHub Blog를 개설 했습니다.   Tistory에 Blog들이 Kakao로 통합되면서, 관리가 어려운 상황이 되어서, Git Blog로 만들어 보았습니다.   꿰보는 (꿰)어야 (보)배에서 아이디어를 얻었고, 개발과 관련된 학습 시행착오를 정리할 예정입니다.   ","categories": ["blog"],
        "tags": ["blog"],
        "url": "/blog/blog_open/",
        "teaser": null
      },{
        ...
        "excerpt":"어떤 알고리즘이 있고, 어떤 때 쓰는지를 정리해보려는 목적 입니다. 정리하려고 알게된 몇가지 사실은 9세기 페르시아의 수학자인 무하마드 알콰리즈미 의 이름을 라틴어화한 algorismus 에서 유래 되었답니다. 위키백과의 알고리즘 정의를 보면 수학과 컴퓨터 과학, 언어학 또는 관련 분야에서 어떠한 문제를 해결하기 위해 정해진 일련의 절차나 방법을 공식화한 형태로 표현한 것. 정리 시작!!!...","categories": ["algorithm"],
        ...
        "excerpt":"몇몇은 자주 사용하지만, 알고 있으면 편리한 자료구조 목차. 자세한 샘플들은 CodingTest 메뉴에서 확인 필수. 단순 구조 정수 실수 문자 문자열 선형 구조 (선형/순차) 리스트 배열 (Array) 레코드 연결 리스트 (Linked List) 단순 연결 리스트 이중 연결 리스트 원형 연결 리스트 스택 (Stack) 큐 (Queue) 데크 (Deque) 비선형 구조 트리 (Tree)...","categories": ["algorithm"],
